...
_PROJECT_DIR=./com.amazingcow.dummytextures
...
install:
	...
	cp ./build/Release/com.amazingcow.dummytextures.exe $(_INSTALL_DIR_BIN)/dummy-textures;
	$(SILENT) echo "---> Done...";
...
dev-build:
	...
	$(_XBUILD) $(_PROJECT_DIR)/com.amazingcow.dummytextures.csproj;
